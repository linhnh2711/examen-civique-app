...
Nouvelle version disponible ! Entraînez-vous avec des quiz interactifs et des examens blancs pour réussir votre examen civique français.
...
examen civique,naturalisation,citoyenneté française,carte résident,CSP,CR,quiz,France,immigration,test
...
## Age Rating
**4+** (Pas de contenu sensible, application éducative)

---

## Copyright
© 2026 Linh NH. All rights reserved.
...
Cette application éducative aide les utilisateurs à se préparer pour l'examen civique français requis pour la naturalisation ou la carte de résident.

L'application fonctionne entièrement hors ligne après installation. La synchronisation cloud (via Firebase) est optionnelle et nécessite une connexion utilisateur.

Aucune donnée sensible n'est collectée. Les données de progression sont stockées localement sur l'appareil.

---

## Export Compliance
**Does your app use encryption?**: NO
(L'app utilise HTTPS standard pour la communication réseau, pas de cryptographie custom)

---

## Promotional Text Alternatives

Version 1 (170 char):
Réussissez votre examen civique ! Quiz personnalisables, examens blancs, flashcards et suivi détaillé de progression. Entraînez-vous efficacement.

Version 2 (170 char):
Application officieuse d'entraînement pour l'examen civique français. 400+ questions, statistiques détaillées, mode hors ligne. Gratuit !

Version 3 (170 char):
Préparez l'examen civique pour votre naturalisation ou carte de résident. Quiz, examens blancs, révisions ciblées. Interface moderne.
